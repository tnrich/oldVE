...
Ext.define("Teselagen.manager.RailManager", {
    ...
    constructor: function(inData) {
        ...
        this.rail = Ext.create("Vesa.view.rail.Rail", {
            items: [
                Ext.create("Vesa.view.rail.Frame"),
    ...
    applySequenceManager: function(pSequenceManager) {
        ...
        this.nameBox = Ext.create("Vesa.view.rail.NameBox", {
            center: this.center,
     ...
     */
    initRail: function() {
        this.caret = Ext.create("Vesa.view.rail.Caret", {
            start: 0,
            reference: this.reference,
            railWidth: this.railWidth,
            length: 3
