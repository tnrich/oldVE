Ext.define('Vesa.view.override.RestrictionEnzymesManagerWindow', {
    requires: 'Vesa.view.RestrictionEnzymesManagerWindow'
}, function() {
    Ext.override(Vesa.view.RestrictionEnzymesManagerWindow, {
