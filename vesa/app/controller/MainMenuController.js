Ext.define('Vesa.controller.MainMenuController', {
    ...
    onSelectMenuItemClick: function() {
        var selectWindow = Ext.create("Vesa.view.SelectWindow");
    ...
    onImportMenuItemClick: function(item, e, options) {
        Ext.create("Vesa.view.FileImportWindow").show();
    },
    ...
    onSimulateDigestionMenuItemClick: function() {
        console.log("called");
        var simulateDigestionWindow = Ext.create("Vesa.view.SimulateDigestionWindow");
