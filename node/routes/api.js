...
module.exports = function(app, express) {
    ...
    app.post('/user/projects/veprojects/sequences', restrict, function(req, res) {
    ...
    //CREATE
    app.post('/user/projects/deprojects/parts', restrict,  function(req, res) {
    ...
    //PUT
    app.put('/user/projects/deprojects/parts', restrict,  function(req, res) {
    ...
    //GET
    app.get('/user/projects/deprojects/parts', restrict,  function(req, res) {
