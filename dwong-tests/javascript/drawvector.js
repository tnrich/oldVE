...
a = document.test2.txta.value
b = document.test2.txtb.value
c = document.test2.txtc.value
d = document.test2.txtd.value
e = document.test2.txte.value
o = a + b + c + d + e
document.test2.otxta.value = o
document.test2.otxtb.value = o.length
