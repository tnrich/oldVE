...
Ext.define("Teselagen.manager.SequenceManager", {
    ...
    setMemento: function(pMemento) {
        ...
        Vesa.application.fireEvent(this.updateSequenceChanged, this.updateKindSetMemento, null);
    },
    ...
    addFeature: function(pFeature, quiet) {
        ...
        if (!quiet && !this.manualUpdateStarted) {
            Vesa.application.fireEvent(this.updateSequenceChanging, this.updateKindFeatureAdd, this.createMemento());
        }
        this.features.push(pFeature);

        if (!quiet && !this.manualUpdateStarted) {
            Vesa.application.fireEvent(this.updateSequenceChanged, this.updateKindFeatureAdd, pFeature);
        }
    },
    ...
    addFeatures: function(pFeaturesToAdd, quiet) {
        ...
        if ( !quiet && !this.manualUpdateStarted) {
            Vesa.application.fireEvent(this.updateSequenceChanging, this.updateKindFeaturesAdd, this.createMemento());
        ...
        if (!quiet && !this.manualUpdateStarted) {
            Vesa.application.fireEvent(this.updateSequenceChanged, this.updateKindFeaturesAdd, pFeaturesToAdd);
        }
        return true;
    },
    ...
    removeFeature: function(pFeature, quiet) {
        ...
        if ( index >= 0 ) {
            if (!quiet && !this.manualUpdateStarted) {
                Vesa.application.fireEvent(this.updateSequenceChanging, this.updateKindFeatureRemove, this.createMemento());
            }
            //this.features.removeItemAt(index);
            Ext.Array.remove(this.features, pFeature);

            if (!quiet && !this.manualUpdateStarted) {
                Vesa.application.fireEvent(this.updateSequenceChanged, this.updateKindFeatureRemove, pFeature);
            }
            return true;
        } else {
            return false;
    ...
    removeFeatures: function(pFeaturesToRemove, quiet) {
        ...
        if (!pFeaturesToRemove && !this.manualUpdateStarted) {
            Vesa.application.fireEvent(this.updateSequenceChanging, this.updateKindFeaturesRemove, this.createMemento());
        }
        ...
        if (!pFeaturesToRemove && !this.manualUpdateStarted) {
            Vesa.application.fireEvent(this.updateSequenceChanged, this.updateKindFeaturesRemove, pFeaturesToRemove);
        }
        return true;
    },
    ...
    insertSequenceManager: function(pSequenceManager, pPosition, pQuiet) {
        ...
        if(!pQuiet && !this.manualUpdateStarted) {
            Vesa.application.fireEvent(this.updateSequenceChanging, this.updateKindSequenceInsert, this.createMemento());
        }
        ...
        if(!pQuiet && !this.manualUpdateStarted) {
            Vesa.application.fireEvent(this.updateSequenceChanged, this.updateKindSequenceInsert, {sequenceProvider: pSequenceManager, position: pPosition});
        }
    ...
    insertSequence: function(pInsertSequence, pPosition, pQuiet) {
        ...
        if(!pQuiet && !this.manualUpdateStarted) {
            Vesa.application.fireEvent(this.updateSequenceChanged, this.updateKindSequenceInsert, {sequence: pInsertSequence, position: pPosition});
        }
        return true;
    },
    ...
    removeSequence: function(pStartIndex, pEndIndex, quiet) {
        ...
        if (!quiet && !this.manualUpdateStarted) {
            Vesa.application.fireEvent(this.updateSequenceChanging, this.updateKindSequenceRemove, this.createMemento());
        ...
        if(!quiet && !this.manualUpdateStarted) {
            Vesa.application.fireEvent(this.updateSequenceChanged, this.updateKindSequenceRemove, {position: pStartIndex, length: removeSequenceLength}); 
    ...
    manualUpdateStart: function() {
        if(!this.manualUpdateStarted) {
            ...
            Vesa.application.fireEvent(this.updateSequenceChanging, this.updateKindKManualUpdate, this.createMemento());
    ...
    manualUpdateEnd: function() {
        if(this.manualUpdateStarted) {
            Vesa.application.fireEvent(this.updateSequenceChanged, this.updateKindKManualUpdate, null);
