...
//Written by Paul Stothard, University of Alberta, Canada
	...
	if ((checkFormElement (theDocument.input_form.elements[0]) == false) || (verifyGenBankFeat (theDocument.input_form.elements[0].value) == false) || (checkTextLength(theDocument.input_form.elements[0].value, maxInput) == false))	{
		return false;
	}

	openWindow("GenBank Feature Extractor");
	openPre();
	genBankFeatExtract(theDocument.input_form.elements[0].value, theDocument.input_form.elements[4].options[theDocument.input_form.elements[4].selectedIndex].value);	
	closePre();
	closeWindow();
	return true;
}
