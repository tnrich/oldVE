...
a = document.test_drawvector.txta.value
b = document.test_drawvector.txtb.value
c = document.test_drawvector.txtc.value
d = document.test_drawvector.txtd.value
e = document.test_drawvector.txte.value
o = a + b + c + d + e
document.test_drawvector.otxta.value = o
document.test_drawvector.otxtb.value = o.length
...
var c = document.getElementById("myDrawvectorCanvas");
