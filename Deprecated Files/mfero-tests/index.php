...
<dt><a href="/"> Simulate Digest Test </a></dt>
<dd><?php include('html/simulatedigest.html');?></dd>
...
<script type="text/javascript"><?php include('javascript/simulatedigest.js');?></script>
