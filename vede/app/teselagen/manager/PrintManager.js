Ext.define("Teselagen.manager.PrintManager", { alias: "PrintManager",
    singleton: true,
    ...
    getPrintStyleSheet: function() {
        ...
        if(printStyleSheets.length<1) {
            console.error("ERROR: No print style sheets.");
        } else if(printStyleSheets.length>1) {
            this.printStyleSheet = printStyleSheets[0];
        } else {
            this.printStyleSheet = printStyleSheets[0];
        }
    },
