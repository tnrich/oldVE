...
Ext.define("Teselagen.models.Part", {
    ...
    isPartVOEmpty: function () {
        ...
        if(partEmpty && this.get("directionForward") === true && this.get("fas") === "") {
            partEmpty = true;
        } else {
            partEmpty = false;
        }
    ...
    isEmpty: function () {
        ...
        if(this.get("name") === "" && this.get("revComp") === false && this.get("genbankStartBP") === 0 && this.get("endBP") === 0 &&
    ...
    isEqual: function (otherPart) {
        ...
        if(this.get("name") === otherPart.get("name") && this.get("revComp") === otherPart.get("revComp") && this.get("genbankStartBP") === otherPart.get("genbankStartBP") && this.get("endBP") === otherPart.get("endBP") &&
